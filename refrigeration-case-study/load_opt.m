...
global LOData gprMdlLP_machine1 gprMdlLP_machine2  Current_Load_Target PMax LOModelData curr_iteration SteadyState gprMdlLP_machine3 gprMdlLP_machine4 gprMdlLP_machine5
...
global LOData gprMdlLP_machine1 gprMdlLP_machine2 Current_Load_Target PMax LOModelData SteadyState explore explore_signal gprMdlLP_machine3 gprMdlLP_machine4 gprMdlLP_machine5
...
if SteadyState==1
    ...
    if min(abs(LOModelData.LoadMachine1-LOData.LoadMachine1(end,1)))>=4
        ...
        % Model Update
        gprMdlLP_machine1 = fitrgp(LOModelData.LoadMachine1,LOModelData.PowerMachine1, 'KernelFunction','ardsquaredexponential');
    else
    end
    % for machine 2
...
% options = optimoptions('fmincon',"EnableFeasibilityMode",true, "SubproblemAlgorithm","cg", 'MaxIterations',500000);
gen_load_target = fmincon(@LoadObjFun,[LOData.LoadMachine1(end,1),LOData.LoadMachine2(end,1), ...
        LOData.LoadMachine3(end,1),LOData.LoadMachine4(end,1),LOData.LoadMachine5(end,1)],[],[],[],[],[56,237,194,194,194],[220,537,795,795,795],@MaxPowerConstraint);
