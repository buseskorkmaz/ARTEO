...
gen_load_target = fmincon(@LoadObjFun_no_exp,[LOData.LoadMachine1(end,1),LOData.LoadMachine2(end,1), ...
        LOData.LoadMachine3(end,1),LOData.LoadMachine4(end,1),LOData.LoadMachine5(end,1)],[],[],[],[],[56,237,194,194,194],[220,537,795,795,795],@MaxPowerConstraint_without_unc, options);
